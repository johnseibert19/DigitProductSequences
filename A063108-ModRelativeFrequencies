...
unsigned long long terms = 242000;
 ...
 * Postcondition: Idnetifies next term.
 */
...
void precomputeBase1() {
    ofstream outFile("modCounts500000.txt");
    unsigned long long a063108Terms[terms];
    set<unsigned long long> a063108;
    a063108Terms[0] = 531230547362;
    // a063108.insert(531230547362);
    unsigned long long mod0Count = 42100;
    unsigned long long mod1Count = 54;
    unsigned long long mod2Count = 59674;
    unsigned long long mod3Count = 161;
    unsigned long long mod4Count = 29371;
    unsigned long long mod5Count = 61554;
    unsigned long long mod6Count = 37317;
    unsigned long long mod7Count = 103;
    unsigned long long mod8Count = 27456;
    unsigned long long mod9Count = 210;
    ...
    outFile << endl;
    outFile << endl;
    outFile << "Proportion of mod 0 count: " << (double)mod0Count / (258000+terms) << endl;
    outFile << "Proportion of mod 1 count: " << (double)mod1Count / (258000+terms) << endl;
    outFile << "Proportion of mod 2 count: " << (double)mod2Count / (258000+terms) << endl;
    outFile << "Proportion of mod 3 count: " << (double)mod3Count / (258000+terms) << endl;
    outFile << "Proportion of mod 4 count: " << (double)mod4Count / (258000+terms) << endl;
    outFile << "Proportion of mod 5 count: " << (double)mod5Count / (258000+terms) << endl;
    outFile << "Proportion of mod 6 count: " << (double)mod6Count / (258000+terms) << endl;
    outFile << "Proportion of mod 7 count: " << (double)mod7Count / (258000+terms) << endl;
    outFile << "Proportion of mod 8 count: " << (double)mod8Count / (258000+terms) << endl;
    outFile << "Proportion of mod 9 count: " << (double)mod9Count / (258000+terms) << endl;
    outFile << "Maximum term: " << a063108Terms[terms-1];
    // calcBaseN(a063108);
}
